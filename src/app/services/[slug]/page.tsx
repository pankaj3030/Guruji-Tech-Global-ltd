...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  if (!service) {
    return {
      title: 'Service Not Found | Guruji Tech Global',
    };
  }

  return {
    title: `${service.title} | Coventry | Guruji Tech Global`,
    description: service.description,
    keywords: [service.title, 'Coventry', 'UK', 'IT services'],
    openGraph: {
      title: `${service.title} | Guruji Tech Global`,
      description: service.description,
      type: 'website',
    },
  };
  ...
  return (
    <>
      <ServiceSchema
        name={service.title}
        description={service.description}
        url={`https://gurujitechglobal.com/services/${service.slug}`}
        imageUrl={`https://gurujitechglobal.com${service.image}`}
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div>
              <h2 className="text-4xl font-bold mb-6">
                About <span className="text-[oklch(0.35_0.12_260)]">{service.title}</span>
              </h2>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold mb-4">
              Our <span className="text-[oklch(0.35_0.12_260)]">Capabilities</span>
            </h2>
            <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
              End-to-end {service.title.toLowerCase()} services tailored to your needs
            </p>
          </div>
      ...
      <section className="py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-16">
            <div>
              <h2 className="text-4xl font-bold mb-6">
                Why Choose Our <span className="text-[oklch(0.35_0.12_260)]">{service.title}?</span>
              </h2>
              <p className="text-lg text-muted-foreground mb-8">
                We combine deep expertise with proven methodologies to deliver service that accelerates your business transformation.
              </p>
            </div>
