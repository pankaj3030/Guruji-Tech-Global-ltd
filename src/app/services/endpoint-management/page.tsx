...
import { ArrowRight, ArrowLeft, CheckCircle2, Monitor, Shield, Smartphone, Wifi, Users, Lock } from 'lucide-react';

export const metadata: Metadata = {
  title: 'Endpoint Management | Device Monitoring Coventry | Guruji Tech Global',
  description: 'Device monitoring and control in Coventry, UK. Security policy enforcement and software deployment and updates.',
  keywords: ['endpoint management Coventry', 'device monitoring UK', 'MDM solutions', 'mobile device management'],
  openGraph: {
    title: 'Endpoint Management | Guruji Tech Global',
    description: 'Device monitoring, control, and security policy enforcement.',
    type: 'website',
  },
};
  ...
  const features = [
    {
      ...
      description: 'Real-time visibility into all connected devices',
    },
    {
      icon: Shield,
      title: 'Security Policy Enforcement',
      description: 'Automated security policy enforcement across all endpoints',
    },
    {
      icon: Smartphone,
      title: 'Software Deployment',
      description: 'Automated software patching and updates',
    },
    {
      icon: Users,
      title: 'Remote Device Management',
      description: 'Control and manage devices from anywhere',
    },
  ];
  ...
  return (
    <>
      <ServiceSchema
        ...
        url="https://gurujitechglobal.com/services/endpoint-management"
        imageUrl="https://gurujitechglobal.com/service-endpoint-management.webp"
      ...
      <section className="relative pt-32 pb-20 overflow-hidden">
        <div className="absolute inset-0 z-0">
          <img
            src="/service-endpoint-management.webp"
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-left text-white">
          ...
          <p className="text-xl text-white/90 max-w-3xl">
            Device monitoring and control solutions in Coventry
          </p>
        </div>
      </section>
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div>
              <h2 className="text-4xl font-bold mb-6">
                About <span className="text-[oklch(0.35_0.12_260)]">Endpoint Management</span>
              </h2>
              <p className="text-lg text-muted-foreground mb-6 leading-relaxed">
                Our endpoint management solutions help organizations secure and manage all devices connected to their network. We implement modern endpoint management platforms that provide visibility, control, and automation for desktops, laptops, mobile devices, and servers. This ensures all endpoints are secure and compliant.
              </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold mb-4">
              Our Endpoint Management <span className="text-[oklch(0.35_0.12_260)]">Capabilities</span>
            </h2>
            <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
              Device management, security, and automation
            </p>
          </div>
      ...
      <section className="py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-16">
            <div>
              <h2 className="text-4xl font-bold mb-6">
                Why Choose Our <span className="text-[oklch(0.35_0.12_260)]">Endpoint Management</span>?
              </h2>
              <p className="text-lg text-muted-foreground mb-8">
                We combine deep expertise with proven methodologies to deliver endpoint solutions that secure your entire infrastructure.
              </p>
            </div>
      ...
      <section className="py-20 bg-gradient-to-r from-[oklch(0.35_0.12_260)] to-[oklch(0.5_0.2_25)]">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center text-white">
          ...
          <p className="text-xl opacity-90 mb-8">
            Let's discuss how endpoint management can protect your business
          </p>
